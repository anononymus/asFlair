...
import glob
files = glob.glob('corpus/train/train_split_4')
...
for file in files:
    ...
    with open(file, 'r', encoding='utf-8') as f:
        ...
        for line in f:
            ...
            #counter.update(chars.encode('utf-8'))
...
for letter, count in counter.most_common():
    ...
    #char_dictionary.add_item(letter.encode('utf-8'))
    idx += 1
    #print('%d\t%s\t%7d\t%7d\t%f' % (idx, letter, count, sum, percentile))
    print('%d\t%s\t%7d\t%7d\t%f' % (idx, letter.encode('utf-8'), count, sum, percentile))
